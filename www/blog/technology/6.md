found this example: https://www.nginx.com/resources/wiki/start/topics/examples/full/

my simple conf for figuring out Lucee Docker Images:
```json
...
server {
  ...
  server_name ori.devlocal.emotions.ch; #that's the only thing I've changed
